...
REGION = 'us-east-1'
ACCESS_KEY_ID = 'AKIAYXN6CFNLMQKVEIQR' 
SECRET_ACCESS_KEY = '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'
...
def preProcess(image_path):
    ...
    #print("Latency: {:.2f} seconds.".format(time.time() - start_time))
...
def requestPred(vid_path):
    ...
    try:
        ...
        if success:
            ...
            url = 'https://3odtckiu14.execute-api.us-east-1.amazonaws.com/default/lambda_file'
            urlcont = 'https://irp5nyogik.execute-api.us-east-1.amazonaws.com/default/test-8'
